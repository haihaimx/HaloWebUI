<script lang="ts">
	...
	export let type: 'tool' | 'function' = 'tool';
			...
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				...
				>
					...
					<div class="flex justify-end pt-3 text-sm font-medium">
						<button
							class="px-3.5 py-1.5 text-sm font-medium bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-full flex items-center {saving
								? ' cursor-not-allowed'
								: ''}"
							type="submit"
							disabled={saving}
